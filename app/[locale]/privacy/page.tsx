...
const SECTIONS = [
  ...
  { title: "4. Data Sharing", content: "We do not sell your personal data. We share data only with: (a) assigned petition operators (case-specific, need-to-know basis only); (b) Google (Firebase/Gemini — for platform infrastructure and AI features); (c) law enforcement, when legally compelled by a valid court order. We will notify you of any such request to the extent permitted by law." },
  { title: "5. AI Data Processing", content: "When you use Hamroh AI, your messages and uploaded documents are processed by Google Gemini AI. This data is sent to Google's API infrastructure. We configure Gemini with safety settings that prevent storage of your conversations beyond the current session. We do not use your conversations to train AI models." },
